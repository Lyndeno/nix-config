{pkgs, ...}: rec {
  ...
  files = {
    morpheus = pkgs.writeText "lsanche-morpheus.pub" ''
    ${morpheus}
    '';
    neo = pkgs.writeText "lsanche-neo.pub" ''
    ${neo}
    '';
    oracle = pkgs.writeText "lsanche-oracle.pub" ''
    ${oracle}
    '';
    trinity = pkgs.writeText "lsanche-trinity.pub" ''
    ${trinity}
    '';
  };
}